...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<!-- 标题 -->
			<div class="index-title" :style='{"padding":"20px 0 10px 0","boxShadow":"8px 8px 1px #009999","margin":"10px auto","borderColor":"rgba(255, 204, 0, 1)","backgroundColor":"rgba(255, 204, 0, 1)","color":"rgba(0, 51, 102, 1)","borderRadius":"0","alignItems":"center","borderWidth":"0 0 0 10px","fontSize":"16px","borderStyle":"solid"}'>
			  <span>NEWS / INFORMATION</span><span>网站公告</span>
			</div>
			<!-- 标题 -->
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"0","margin":"10px auto","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","background":"white","borderStyle":"solid"}'>
				...
				<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"none","margin":"20px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 153, 153, 1)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#fff","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>标题</div>
					...
					<!-- 样式二 -->
					<div class="list news">
						<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" class="list-item" :class="2=='1'?'list-item1':2=='3'?'list-item3':''">
							<div class="list-item-body animation-box" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"20px 30px 10px ","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 204, 0, 1)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
								<img :style='{"boxShadow":"none","borderColor":"rgba(0,0,0,.3)","borderRadius":"100%","borderWidth":"0","width":"150px","borderStyle":"solid","height":"150px"}' :src="baseurl+item.picture">
								<div class="item-info">
									<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","width":"100%","fontSize":"18px"}' class="name">{{item.title}}</div>
									<div v-if="item.introduction" :style='{"padding":"0","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 51, 102, 1)","borderRadius":"0","textAlign":"left","width":"100%","fontSize":"16px"}' class="time">{{item.introduction}}</div>
								</div>
							</div>
						</div>
					</div>
