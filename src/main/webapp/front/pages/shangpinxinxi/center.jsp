...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<div class="index-title" :style='{"padding":"10px","boxShadow":"8px 8px 1px #009999","margin":"10px auto","borderColor":"rgba(255, 204, 0, 1)","backgroundColor":"rgba(255, 204, 0, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0 0 0 10px","fontSize":"20px","borderStyle":"solid","height":"auto"}'>
			...
			<div class="center-container">
				<!-- 个人中心菜单 config.js-->
				<div class="left-container" :style='{"padding":"0","boxShadow":"none","margin":"0","borderColor":"rgba(0, 153, 153, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"1px 0 1px 1px ","width":"160px","borderStyle":"solid"}'>
				...
				<!-- 个人中心菜单 -->
				<!-- 个人中心 -->
				<div class="right-container" :style='{"padding":"20px","boxShadow":"none","margin":"0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"1px","borderStyle":"solid"}'>
					<form class="layui-form" lay-filter="myForm">
						<!-- 主键 -->
						<input type="hidden" name="id" id="id" />
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
							...
							<div class="layui-input-block">
								<img id="tupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :style='{"boxShadow":"none","borderColor":"#DCDFE6","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"1px","width":"80px","borderStyle":"solid","height":"80px"}' src="../../img/avator.png">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
							...
							<div class="layui-input-block">
								<button :style='{"padding":"0 10px","boxShadow":"none","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(255, 204, 0, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="tupianUpload">
									<i v-if="true" :style='{"color":"#fff","show":true,"fontSize":"14px"}' class="layui-icon">&#xe67c;</i>上传图片
								</button>
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">上架日期</label>
							<div class="layui-input-block date">
								<input type="text" name="shangjiariqi" id="shangjiariqi" placeholder="上架日期" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">积分</label>
							<div class="layui-input-block input">
								<input type="number" name="jf" id="jf" placeholder="积分" autocomplete="off" class="layui-input" disabled="disabled">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"none","margin":"0 0 10px 0","borderColor":"rgba(0, 51, 102, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"dashed"}'>
						...
						<div class="layui-form-item">
							<div class="layui-input-block" style="display: flex;flex-wrap:wrap;">
								<button :style='{"padding":"0 10px","boxShadow":"none","margin":"10px auto 0","borderColor":"#ccc","backgroundColor":"rgba(0, 153, 153, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"60%","fontSize":"14px","borderStyle":"solid","height":"44px"}' class="layui-btn btn-submit btn-theme" lay-submit lay-filter="*">更新信息</button>
				<button :style='{"padding":"0 10px","boxShadow":"none","margin":"10px auto","borderColor":"#ccc","backgroundColor":"rgba(0, 153, 153, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"8px","borderWidth":"0","width":"60%","fontSize":"14px","borderStyle":"solid","height":"44px"}' @click="logout" class="layui-btn btn-submit">退出登录</button>
							</div>
						</div>
						<!-- <div class="layui-form-item">
							<div class="layui-input-block">
