				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.name" type="text" :readonly="ro.name" name="name" id="name" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<button v-if="!ro.value" type="button" class="layui-btn btn-theme" id="valueUpload">
								<i class="layui-icon">&#xe67c;</i>上传值
							</button>
						</div>
					</div>
