						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="shangpinfenlei" name="shangpinfenlei" class="form-control" v-model="ruleForm.shangpinfenlei" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>品牌</label>
									...
									<input id="jf" name="jf" class="form-control" v-model="ruleForm.jf" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>价格</label>
									...
									<div class="form-group  col-md-12">
										<label>商品介绍</label>
										<script id="shangpinjieshaoEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.shangpinjieshao != null && ruleForm.shangpinjieshao != 'null' && ruleForm.shangpinjieshao != ''){
				var mes = '' + ruleForm.shangpinjieshao;
				var shangpinjieshaoUeditor = UE.getEditor('shangpinjieshaoEditor');
				shangpinjieshaoUeditor.ready(function() {
					shangpinjieshaoUeditor.setContent(mes);
					shangpinjieshaoUeditor.setDisabled('fullscreen');
				});
			}
		}  
