...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<select name="shangpinfenlei" id="shangpinfenleiSelect" class="form-control form-control-sm" aria-controls="tableId">
									</select>
									<label>
										品牌
									</label>
									<input type="text" id="pinpaiSearch" class="form-control form-control-sm" placeholder="请输入品牌" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jf')">积分<i id="jfIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shangpinjieshaoCell  = document.createElement('td');
			...
			var jfCell  = document.createElement('td');

						  jfCell.innerHTML = item.jf; 


			row.appendChild(jfCell);
